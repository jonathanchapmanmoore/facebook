namespace FacebookClient
{
    ...
    /// <summary>
    /// Interaction logic for UpdateStatusControlModern.xaml
    /// </summary>
    ...
    public partial class UpdateStatusControlModern : UserControl
    {
        ...
        public static readonly DependencyProperty DisplayModeProperty = DependencyProperty.Register("DisplayMode", typeof(StatusDisplayMode), typeof(UpdateStatusControlModern),
            new FrameworkPropertyMetadata(StatusDisplayMode.Base));
        public static readonly DependencyProperty IsActiveProperty =
            DependencyProperty.Register("IsActive", typeof(bool), typeof(UpdateStatusControlModern),
        ...
        {
            ((UpdateStatusControlModern)d).OnIsActiveChanged(e);
        }
        ...
        protected virtual void OnIsActiveChanged(DependencyPropertyChangedEventArgs e)
        {
            if ((bool)e.NewValue)
            {
                if (shareTextBox != null)
                {
                    Action a = () => shareTextBox.Focus();
        ...
        static UpdateStatusControlModern()
        {
            UpdateStatusCommand = new RoutedCommand("UpdateStatus", typeof(UpdateStatusControlModern));
        }

        public UpdateStatusControlModern()
        {
            InitializeComponent();
