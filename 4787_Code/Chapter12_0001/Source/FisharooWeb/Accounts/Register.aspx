...
<asp:Content ContentPlaceHolderID="Content" runat="server">
    <asp:Panel ID="pnlCreateAccount" runat="server">
        <div class="divContainer">
            ...
            <asp:Wizard OnNextButtonClick="wizRegister_NextButtonClick" OnActiveStepChanged="wizRegister_ActiveStepChanged" ID="wizRegister" OnFinishButtonClick="wizRegister_FinishButtonClicked" CssClass="Wizard"  runat="server">
                <HeaderTemplate>
