...
namespace Fisharoo.FisharooWeb.UserControls.Presenters
{
    public class RatingsPresenter
    {
        ...
        public RatingsPresenter()
        {
            ...
            _systemObjectRatingOptionsRepository = ObjectFactory.GetInstance<ISystemObjectRatingOptionsRepository>();
        ...
        {
            _view.LoadOptions(_systemObjectRatingOptionsRepository.GetSystemObjectRatingOptionsBySystemObjectID(SystemObjectID));
        }
        ...
        public void btnSave_Click(object sender, EventArgs e, int SystemObjectID, long SystemObjectRecordID)
        {
            ...
            {
                foreach (KeyValuePair<int, int> pair in _webContext.SelectedRatings)
                {
