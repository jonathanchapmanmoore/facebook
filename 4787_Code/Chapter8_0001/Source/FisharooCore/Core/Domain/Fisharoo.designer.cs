...
namespace Fisharoo.FisharooCore.Core.Domain
{
    ...
    partial void InsertBoardPostView(BoardPostView instance);
    partial void UpdateBoardPostView(BoardPostView instance);
    partial void DeleteBoardPostView(BoardPostView instance);
    ...
    partial void DeleteBoardPost(BoardPost instance);
		...
		public System.Data.Linq.Table<BoardPostView> BoardPostViews
		{
			get
			{
				return this.GetTable<BoardPostView>();
			}
		}
	...
	[Table(Name="dbo.BoardPostViews")]
	public partial class BoardPostView : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private long _PostViewID;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnPostViewIDChanging(long value);
    ...
    partial void OnCreateDateChanged();
		...
		[Column(Storage="_PostViewID", AutoSync=AutoSync.OnInsert, DbType="BigInt NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_PostID", DbType="BigInt NOT NULL")]
		public long PostID
		{
			get
			{
