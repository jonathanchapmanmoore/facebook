<%@ Page Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Fisharoo.FisharooWeb.Account.Register" %>
    ...
    <asp:Panel ID="pnlCreateAccount" runat="server">
        <div class="divContainer">
            <div class="divContainerRow">
                ...
                <asp:Wizard step OnNextButtonClick="wizRegister_NextButtonClick" OnActiveStepChanged="wizRegister_ActiveStepChanged" ID="wizRegister" OnFinishButtonClick="wizRegister_FinishButtonClicked" SideBarStyle-CssClass="WizardSideBar" CssClass="Wizard"  runat="server">
                    <HeaderTemplate>
